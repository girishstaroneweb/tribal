                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>welcome" class="active"><i class="ti-home"></i> <span> Dashboard </span> </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>user" class=""><i class="ti-user"></i> <span> Users </span> </a>
                            </li>
                        </ul>
